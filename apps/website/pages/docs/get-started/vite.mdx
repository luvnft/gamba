...
const PLATFORM_CREATOR_ADDRESS = "F5iFyvKbtXhX8BgHyC9tGAfgDKMagVBuygwsSTcUwQAh";
const PLATFORM_CREATOR_FEE = "0.10"; // 5% (5/100 = 0.05)
const PLATFORM_JACKPOT_FEE = "0.02"; // 1% (1/100 = 0.01)
